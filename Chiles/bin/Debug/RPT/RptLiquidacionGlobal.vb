...
Public Class RptLiquidacionGlobal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptLiquidacionGlobal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Chiles.RptLiquidacionGlobal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLiquidacionGlobal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLiquidacionGlobal = New RptLiquidacionGlobal()
        rpt.Site = Me.Site
        Return rpt
    End Function
