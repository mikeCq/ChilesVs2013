...
Public Class RptLiquidacionTotal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptLiquidacionTotal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Chiles.RptLiquidacionTotal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptLiquidacionTotal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptLiquidacionTotal = New RptLiquidacionTotal()
        rpt.Site = Me.Site
        Return rpt
    End Function
